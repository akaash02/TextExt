...
import { PLATFORM, PROJECT_ID, STORAGE_ID, DATABASE_ID, USER_COLLECTION_ID, COURSE_COLLECTION_ID } from '@env';
...
export const appwriteConfig = {
  ...
  courseCollectionId: COURSE_COLLECTION_ID,  // New collection for courses
};
...
export async function createCourse(courseData) {
  try {
    ...
    const course = await databases.createDocument(
      appwriteConfig.databaseId,
      appwriteConfig.courseCollectionId,  // Your course collection ID
      ID.unique(),
      {
        title: courseData.title,
        description: courseData.description,
        category: courseData.category,
        dateOfCreation: courseData.dateOfCreation.toISOString(),
        userId: currentUser.$id,  // You can associate this course with the current user
      }
    );
